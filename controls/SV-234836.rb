...
If any output is returned, this is a finding.)
  desc 'fix', %q(Configure the systemwide shared library files contained in the directories "/lib", "/lib64", "/usr/lib", and "/usr/lib64" are owned by root with the following command:

> sudo find /lib /lib64 /usr/lib /usr/lib64 -type f -name '*.so*' ! -user root -exec chown root {} +)
  impact 0.5
  tag check_id: 'C-38024r1102117_chk'
  tag severity: 'medium'
  tag gid: 'V-234836'
  tag rid: 'SV-234836r1106561_rule'
  tag stig_id: 'SLES-15-010353'
  tag gtitle: 'SRG-OS-000259-GPOS-00100'
  tag fix_id: 'F-37987r1106560_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
