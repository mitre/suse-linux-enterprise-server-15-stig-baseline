...
> sudo augenrules --load'
  impact 0.5
  tag check_id: 'C-38089r986502_chk'
  tag severity: 'medium'
  tag gid: 'V-234901'
  ...
  tag 'documentable'
  tag cci: ['CCI-000018', 'CCI-000172', 'CCI-001403', 'CCI-002130', 'CCI-000015', 'CCI-002132']
  tag nist: ['AC-2 (4)', 'AU-12 c', 'AC-2 (4)', 'AC-2 (4)', 'AC-2 (1)', 'AC-2 (4)']
end
